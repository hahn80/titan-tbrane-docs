...
{
  "task": "reforming",
  "action": "sentimentalize",
  "kwargs": {
    "input_arrow": "sentimentalize.arrow",
    "output_arrow": "/tmp/tmp93ezxtoc",
...
public class Sentimentalize {
    public static void main(String[] args) {
        ...
        try (PythonInterpreter interpreter = new PythonInterpreter(config)) {
            ...
            try (FileReader reader = new FileReader("sentimentalize.txt")) {
