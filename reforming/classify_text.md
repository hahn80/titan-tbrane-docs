# Service Text Classify


We will use Java to call Python directly and get the result back as an object, which can further cast as an HashMap and use it in Java.
...
```text_classify.txt
{
  ...
  "kwargs": {
    "input_arrow": "classify_text.arrow",
    "output_arrow": "/tmp/tmpfqpc6b6w",
    "model_name": "Azma-AI/roberta-base-emotion-classifier",
    "source_column": "text",
    "labels": null,
    "label_map": null,
...
public class TextClassifier {
    public static void main(String[] args) {
        ...
        try (PythonInterpreter interpreter = new PythonInterpreter(config)) {
            ...
            try (FileReader reader = new FileReader("text_classify.txt")) {
